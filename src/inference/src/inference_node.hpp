...
class InferenceNode : public rclcpp::Node {
   public:
    InferenceNode() : Node("inference_node") {
        ...
        joint_limits_lower_ = std::vector<float>{-1.0,-0.6,-1.0+0.1,-0.2-0.3,-1.0+0.2,-0.5,-0.6,-1.0,-1.0+0.1,-0.2-0.3,-1.0+0.2,-0.5,-3.14,-2.25-0.18,-0.25-0.06,-1.57,-0.6-0.78,-1.57,-2.25-0.18,-2.25+0.06,-1.57,-0.6-0.78,-1.57};
        joint_limits_upper_ = std::vector<float>{ 0.6, 1.0, 1.0+0.1, 2.5-0.3, 1.0+0.2, 0.5, 1.0, 0.6, 1.0+0.1, 2.5-0.3, 1.0+0.2, 0.5, 3.14, 1.57-0.18, 2.25-0.06, 1.57,1.57-0.78, 1.57, 1.57-0.18, 0.25+0.06, 1.57,1.57-0.78, 1.57};
